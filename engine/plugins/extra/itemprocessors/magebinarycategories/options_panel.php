...
<div class="formline">
	<span>Do not overwrite</span>
	<input type="number" name="CAT:nooverwrite"
		   value="<?php echo $this->getParam("CAT:nooverwrite", "1") ?>" />
	<div class="fieldinfo">Enter 0, if it is ok to overwrite all the existing categories, otherwise the value should be 1</div>
</div>
